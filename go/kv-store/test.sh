...
# Upload image files
curl -i -H "Content-Type: image/png" --data-binary @images/Go-Logo_Aqua.png -v localhost:8080/images/logo
curl -i -H "Content-Type: image/png" --data-binary @images/Golang.png -v localhost:8080/images/gopher
